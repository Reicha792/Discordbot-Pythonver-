...
TOKEN = 'NzUyMDY5MDgwMTc3MTgwNzUy.X1SQ6Q.i1HLFC5jGRA59O1iz2DYqzmpRaA'
channel_id = 752070484513783820
...
async def on_message(message):
    ...
    and message.content.startswith(COMMAND_PREFIX):
        ...
        #elif '何度' in message.content:
            #await message.channel.send('センサーからの応答がありません。故障している可能性があります。')
        #照度
